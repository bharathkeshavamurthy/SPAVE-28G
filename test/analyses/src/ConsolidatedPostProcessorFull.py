...
# rx_gps_dir = '<dataset_location>/urban-campus-I/rx-realm/gps/'
# rx_imu_dir = '<dataset_location>/urban-campus-I/rx-realm/imu/'
# tx_imu_dir, tx_imu_skip_step = '<dataset_location>/urban-campus-I/tx-realm/imu/', 1
...
# rx_gps_dir = '<dataset_location>/urban-campus-II/rx-realm/gps/'
# rx_imu_dir = '<dataset_location>/urban-campus-II/rx-realm/imu/'
# tx_imu_dir, tx_imu_skip_step = '<dataset_location>/urban-campus-II/tx-realm/imu/', 5
...
rx_gps_dir = '<dataset_location>/urban-campus-III/rx-realm/gps/'
rx_imu_dir = '<dataset_location>/urban-campus-III/rx-realm/imu/'
tx_imu_dir, tx_imu_skip_step = '<dataset_location>/urban-campus-III/tx-realm/imu/', 5
...
# rx_gps_dir = '<dataset_location>/urban-garage/rx-realm/gps/'
# rx_imu_dir = '<dataset_location>/urban-garage/rx-realm/imu/'
# tx_imu_dir, tx_imu_skip_step = '<dataset_location>/urban-garage/tx-realm/imu/', 1
...
# rx_gps_dir = '<dataset_location>/urban-stadium/rx-realm/gps/'
# rx_imu_dir = '<dataset_location>/urban-stadium/rx-realm/imu/'
# tx_imu_dir, tx_imu_skip_step = '<dataset_location>/urban-stadium/tx-realm/imu/', 5
...
# rx_gps_dir = '<dataset_location>/suburban-fraternities/rx-realm/gps/'
# rx_imu_dir = '<dataset_location>/suburban-fraternities/rx-realm/imu/'
# tx_imu_dir, tx_imu_skip_step = '<dataset_location>/suburban-fraternities/tx-realm/imu/', 1
...
# rx_gps_dir = '<dataset_location>/urban-vegetation/rx-realm/gps/'
# rx_imu_dir = '<dataset_location>/urban-vegetation/rx-realm/imu/'
# tx_imu_dir, tx_imu_skip_step = '<dataset_location>/urban-vegetation/tx-realm/imu/', 1
...
max_ant_gain, max_mpcs, pn_v0, pn_l, pn_reps = 22.0, 1000, 0.5, 11, 11
n_sigma, ant_log_file = 0.015, '<dataset_location>/antenna_pattern.mat'
