...
google_map = gmap('<google_maps_api_key>', google_map_options, width=8500, height=3500)
...
export_png(google_map, filename='<output_file_location>', width=8500, height=3500, timeout=12000)
